...
//     const behavior = new FullScreenBehavior(true, '', postEvent);
//
...
//     const behavior = new FullScreenBehavior(true, '', vi.fn(() => {}));
...
//     const postEvent = vi.fn(() => {});
//     const behavior = new FullScreenBehavior(false, '', postEvent);
//
//     expect(postEvent).toHaveBeenCalledTimes(0);
...
//     const behavior = new FullScreenBehavior(false, '', vi.fn(() => {}));
//     const listener = vi.fn();
//
//     behavior.on('change:isVerticalSwipeEnabled', listener);
//     expect(listener).toHaveBeenCalledTimes(0);
...
//       expect(
//         new FullScreenBehavior(false, '7.6', vi.fn(() => {})).supports('disableVerticalSwipe'),
//       ).toBe(false);
//
//       expect(
//         new FullScreenBehavior(false, '7.7', vi.fn(() => {})).supports('disableVerticalSwipe'),
//       ).toBe(true);
//     });
//   });
//
...
//     it('should return false if SwipeBehavior was created with version 7.6 or less. True otherwise', () => {
//       expect(
//         new FullScreenBehavior(false, '7.6', vi.fn(() => {})).supports('enableVerticalSwipe')
//       ).toBe(false);
//
//       expect(
//         new FullScreenBehavior(false, '7.7', vi.fn(() => {})).supports('enableVerticalSwipe')
//       ).toBe(true);
//     })
//   })
// });